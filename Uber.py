...
df = pd.read_csv("UberRequestData2024.csv", parse_dates=["Request_timestamp"])
firsthead = df
...
def status():
	...
	st.pyplot(fig)
	st.caption("The above visual shows that more trips were completed but the second highest has not cars availabe so more cars will have to be deployed")
