...
st.set_page_config(page_title="Uber_data_dashboard", page_icon=":bar_chart:", layout="wide")
# --- USER AUTHENTICATION ---
...
authenticator = stauth.Authenticate(credentials, "Uber_data_dashboard", "abcdef", cookie_expiry_days=30)


name, authentication_status, username = authenticator.login(location="main", fields="None")
